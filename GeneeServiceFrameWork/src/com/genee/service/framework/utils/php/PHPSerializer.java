...
package com.genee.service.framework.utils.php;
...
public class PHPSerializer {
	...
	private static int writeObject(ByteArrayOutputStream stream, Object obj,
		...
		if (obj instanceof java.io.Serializable) {
			...
			if (obj instanceof com.genee.service.framework.utils.php.Serializable) {
				byte[] cs = ((com.genee.service.framework.utils.php.Serializable) obj)
						.serialize();
	...
	private static UnSerializeResult readCustomObject(
		...
		if (o == null) {
			stream.skip(n);
		} else if (o instanceof com.genee.service.framework.utils.php.Serializable) {
			byte[] b = new byte[n];

			stream.read(b, 0, n);
			((com.genee.service.framework.utils.php.Serializable) o)
					.unserialize(b);
		} else {
			stream.skip(n);
		}

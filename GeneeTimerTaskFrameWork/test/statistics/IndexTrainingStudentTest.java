...
import com.genee.timertask.module.statistics.index.impl.IndexTrainingStudent;

@RunWith(SpringJUnit4ClassRunner.class)
public class IndexTrainingStudentTest extends BaseTest{

	@Autowired
	@Qualifier("train_stu")
	private IndexTrainingStudent indexTrainingStudent;
	...
	public void test() throws NumberFormatException, ParseException {
		...
		indexTrainingStudent.run(lStartDate, lEndDate, equipments);

...
import com.genee.timertask.module.statistics.index.impl.IndexEssayCount;
import com.genee.timertask.module.statistics.pojo.EquipmentIndexEntity;

@RunWith(SpringJUnit4ClassRunner.class)
public class IndexEssayCountTest extends BaseTest {

	@Autowired
	@Qualifier("essay_cnt")
	private IndexEssayCount indexEssayCount;
	...
	public void test() throws NumberFormatException, ParseException {
		...
		indexEssayCount.run(lStartDate, lEndDate, equipments);

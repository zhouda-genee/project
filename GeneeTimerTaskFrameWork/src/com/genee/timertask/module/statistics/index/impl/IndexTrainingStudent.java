 ...
 * @Description: 培训学生指标<br>统计时段内，已通过培训+团体中通过培训学生人数的总和
 * 			张枚说：一期只做南大定制的
 * 			南大定制：统计时段内，已通过培训通过培训角色为学生人数的总和
 * @author da.zhou@geneegroup.com
 * @date 2014年8月22日 上午11:46:32
 *
 */
@Component("train_stu")
public class IndexTrainingStudent extends IndexBase {
	...
	private List<Map<String, Object>> queryResult(long startDate, long endDate){
		String sql = "select count(a.id) as num, a.equipment_id as equipmentid "
				...
				+ "and a.user_id = b.id "
				+ "and b.member_type in (0,1,2,3) " //学生：0 本科生 1 硕士研究生 2 博士研究生 3 其他

package com.genee.timertask.framework.utils.dateutil;
...
//		System.out.println(DateUtil.calcAge(DateUtil.string2Date("1988-3-7")));
		System.out.println(currentSystemTimeDate());
	}
	...
	/**
	 * 
	 * @Title: currentSystemTimeString 
	 * @Description: 字符串型当前系统时间，包含年月日时分秒 
	 * @return String
	 * @throws
	 */
	public static String currentSystemTimeString(){
		return date2String(new Date(System.currentTimeMillis()), "yyyy-MM-dd HH:mm:ss");
	}
	
	/**
	 * 
	 * @Title: currentSystemTimeDate 
	 * @Description: 日期型当前系统时间，包含年月日时分秒 
	 * @return Date
	 * @throws
	 */
	public static Date currentSystemTimeDate(){

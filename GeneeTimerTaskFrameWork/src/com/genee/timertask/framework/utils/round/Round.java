package com.genee.timertask.framework.utils.round;
...
public class Round {
	...
	public static double round(double number) {
		...
		number = Double.parseDouble(big.setScale(2, BigDecimal.ROUND_HALF_UP)
				.toString());
		return number;
	}
	...
	public static double round(double number, int precision) {
		BigDecimal big = new BigDecimal(number);
		number = Double.parseDouble(big.setScale(precision,
	...
	public static void main(String[] args){
		System.out.println(Round.formatNumber(Double.parseDouble("1.0"), "##,###.00"));
	}
}

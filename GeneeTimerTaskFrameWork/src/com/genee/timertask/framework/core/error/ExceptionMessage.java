package com.genee.timertask.framework.core.error;

import com.genee.timertask.framework.utils.stringutil.StringUtil;
...
public class ExceptionMessage extends Exception {
	...
	public ExceptionMessage(String msgCode) {
	 ...
	 *            错误信息备注
	 */
	public ExceptionMessage(String msgCode, String msgRemark) {
	...
	public boolean equals(Object e) {
		...
		ExceptionMessage e1 = (ExceptionMessage) e;
	...
	public String toString() {
		return "{\"code\": " + msgCode + ", \"message\": " + msgRemark + "}";
	}
}